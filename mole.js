...
function popUpRandomMole() {
  ...
  const moleHeads = document.querySelectorAll('.whack-mole__mole-head:not(.whack-mole__mole-head--whacked)');
  ...
  clickable = true;
  moleHead.classList.remove('whack-mole__mole-head--hidden');
...
function hideMole(mole) {
  clickable = false;
  mole.classList.add('whack-mole__mole-head--hidden');
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const moleHeads = document.querySelectorAll('.whack-mole__mole-head');
  for (let moleHead of moleHeads) {
    moleHead.addEventListener('click', event => {
      ...
      hideMole(event.target);
       ...
       event.target.classList.add('whack-mole__mole-head--hidden');
